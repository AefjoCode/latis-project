...
@section('content')
    <div>
        <div class="card">
            <div class="card-body">
                <h3 class="mb-4">Ubah Data Siswa</h3>
                ...
                <form action="{{ route('student.update', $student) }}" method="POST" enctype="multipart/form-data">
                   @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nis') is-invalid @enderror" id="nis"
                                    placeholder="nis siswa" name="nis" value="{{ $student->nis }}">
                                @error('nis')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_siswa') is-invalid @enderror"
                                    id="nama_siswa" placeholder="nama siswa" name="nama_siswa" value="{{ $student->nama_siswa }}">
                                @error('nama_siswa')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    id="email" placeholder="siswa@latiseducation.com" name="email" value="{{ $student->email }}">
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 custom-file">
                                ...
                                <div class="custom-file">
                                    ...
                                    <input type="file" class="custom-file-input @error('foto') is-invalid @enderror" id="imageInput" name="foto">
                                    <label class="custom-file-label" for="customFile" id="imageInputLabel">Choose file</label>
                                    @error('foto')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <button type="submit" class="btn btn-primary mt-5">Perbarui Data Siswa</button>
